...
namespace AmigaPowerAnalysis.Tests.TestUtilities {
    public static class IntegrationTestUtilities {
        ...
        public static ResultPowerAnalysis RunProject(string filename, bool saveReport = true) {
            ...
            return RunProject(project, project.ProjectName, saveReport);
        }

        public static ResultPowerAnalysis RunProject(Project project, string projectId, bool saveReport = true) {
