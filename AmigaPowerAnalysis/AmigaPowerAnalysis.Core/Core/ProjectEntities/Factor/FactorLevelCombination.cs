...
namespace AmigaPowerAnalysis.Core {
    ...
    [DataContract]
    public class FactorLevelCombination : IEquatable<FactorLevelCombination>, IComparable<FactorLevelCombination> {
        ...
        /// </summary>
        public FactorLevel VarietyLevel {
            get {
                return Levels.FirstOrDefault(fl => fl.Parent.IsVarietyFactor);
            }
        }
